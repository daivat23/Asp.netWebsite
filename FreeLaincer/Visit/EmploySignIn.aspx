<%@ Page Title="" Language="C#" MasterPageFile="~/Visit/Visit.Master" AutoEventWireup="true" CodeBehind="EmploySignIn.aspx.cs" Inherits="FreeLaincer.Visit.EmploySignIn" %>
...
<div class="logindiv"  >
       ...
       <div class="row" style="width:80%;margin:auto;text-align:left">
        ...
        <br>
          ...
          <br>      
          <br>
          <span class="psw"> Not Register Yet?  <a href="Register.aspx" class="btn btn-default"  style="background-color:#202020;color:white" >Register Now</a></span>
